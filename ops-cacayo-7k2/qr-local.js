/* Local QR renderer. Bundled from qrcode-terminal vendor/QRCode (MIT). No token leaves the browser. */
(function(global){
  'use strict';
  var modules={"QRMaskPattern": function(module,exports,require){
module.exports = {
	PATTERN000 : 0,
	PATTERN001 : 1,
	PATTERN010 : 2,
...
module.exports = {
  ...
  var cache={};
  function require(id){ if(cache[id]) return cache[id].exports; if(!modules[id]) throw new Error('QR module not found: '+id); var m={exports:{}}; cache[id]=m; modules[id](m,m.exports,require); return m.exports; }
  ...
  function toDataURL(text,size){
    ...
    var count=qr.getModuleCount(), quiet=4;
  ...
  global.CTDQR={toDataURL:toDataURL};
})(window);
